          ...
          <div className="max-w-[1100px] mx-auto flex flex-col items-center text-center">
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap justify-center gap-6">
                {/* Discord */}
                <a href="https://discord.gg/SNRKrSh2wF" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center">
                ...
                {/* Telegram */}
                <a href="https://t.me/thevibetrading" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center">
